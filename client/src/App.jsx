...
import './style.css'
import EmpruntLivre from './components/EmpruntLivre.jsx'
    ...
    return (
        ...
        <Router>
            <Routes>
                ...
                <Route path="/profile" element={<Template userT={userT}><Profile /></Template>} />
                <Route path="/books/:id" element={<Template userT={userT}><EmpruntLivre /></Template>} />
